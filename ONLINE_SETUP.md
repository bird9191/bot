...
- Вкладка `Лиды` работает как простая CRM: есть русские колонки для статуса, ответственного, следующего контакта, результата звонка и комментария администратора.
